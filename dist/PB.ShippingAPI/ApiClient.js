 ...
 */
/**
* @module PB.ShippingAPI/ApiClient
* @version 1.0.0
*/
/**
...
* @alias module:PB.ShippingAPI/ApiClient
* @class
*/
var ApiClient = /*#__PURE__*/function () {
  function ApiClient() {
     ...
     * @type {String}
     * @default https://api-sandbox.pitneybowes.com/shippingservices
     */
    this.basePath = 'https://api-sandbox.pitneybowes.com/shippingservices'.replace(/\/+$/, '');
  ...
  */
  return _createClass(ApiClient, [{
    ...
    * @param {module:PB.ShippingAPI/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
    ...
    */
     ...
     * @callback module:PB.ShippingAPI/ApiClient~callApiCallback
     ...
     * @param {module:PB.ShippingAPI/ApiClient~callApiCallback} callback The callback function.
...
* @type {module:PB.ShippingAPI/ApiClient}
*/
