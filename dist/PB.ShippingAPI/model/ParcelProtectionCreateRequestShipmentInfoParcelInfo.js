...
var _ParcelProtectionCreateRequestShipmentInfoParcelInfoCommodityList = _interopRequireDefault(require("./ParcelProtectionCreateRequestShipmentInfoParcelInfoCommodityList"));
 ...
 * @version 1.0.0
 */
var ParcelProtectionCreateRequestShipmentInfoParcelInfo = /*#__PURE__*/function () {
  /**
   ...
   */
  function ParcelProtectionCreateRequestShipmentInfoParcelInfo() {
    _classCallCheck(this, ParcelProtectionCreateRequestShipmentInfoParcelInfo);
   ...
   */
  return _createClass(ParcelProtectionCreateRequestShipmentInfoParcelInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('commodityList')) {
          obj['commodityList'] = _ApiClient["default"].convertToType(data['commodityList'], [_ParcelProtectionCreateRequestShipmentInfoParcelInfoCommodityList["default"]]);
        }
      }
      return obj;
    }
...
var _default = exports["default"] = ParcelProtectionCreateRequestShipmentInfoParcelInfo;