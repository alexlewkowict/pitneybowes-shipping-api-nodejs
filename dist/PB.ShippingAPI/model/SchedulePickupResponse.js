 ...
 * @version 1.0.0
 */
var SchedulePickupResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SchedulePickupResponse</code>.
   * @alias module:PB.ShippingAPI/model/SchedulePickupResponse
   */
  function SchedulePickupResponse() {
    _classCallCheck(this, SchedulePickupResponse);
   ...
   */
  return _createClass(SchedulePickupResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('pickupDateTime')) {
          obj['pickupDateTime'] = _ApiClient["default"].convertToType(data['pickupDateTime'], 'String');
        }
        if (data.hasOwnProperty('pickupConfirmationNumber')) {
          obj['pickupConfirmationNumber'] = _ApiClient["default"].convertToType(data['pickupConfirmationNumber'], 'String');
        }
        if (data.hasOwnProperty('pickupId')) {
          obj['pickupId'] = _ApiClient["default"].convertToType(data['pickupId'], 'String');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = SchedulePickupResponse;