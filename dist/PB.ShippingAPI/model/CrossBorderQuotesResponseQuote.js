...
var _CrossBorderQuotesResponseQuoteLines = _interopRequireDefault(require("./CrossBorderQuotesResponseQuoteLines"));
var _CrossBorderQuotesResponseTotalRates = _interopRequireDefault(require("./CrossBorderQuotesResponseTotalRates"));
 ...
 * @version 1.0.0
 */
var CrossBorderQuotesResponseQuote = /*#__PURE__*/function () {
  /**
   ...
   */
  function CrossBorderQuotesResponseQuote() {
    _classCallCheck(this, CrossBorderQuotesResponseQuote);
   ...
   */
  return _createClass(CrossBorderQuotesResponseQuote, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('quoteLines')) {
          obj['quoteLines'] = _ApiClient["default"].convertToType(data['quoteLines'], [_CrossBorderQuotesResponseQuoteLines["default"]]);
        }
        if (data.hasOwnProperty('totalPrice')) {
          obj['totalPrice'] = _ApiClient["default"].convertToType(data['totalPrice'], 'Number');
        }
        if (data.hasOwnProperty('totalRates')) {
          obj['totalRates'] = _CrossBorderQuotesResponseTotalRates["default"].constructFromObject(data['totalRates']);
        }
      }
      return obj;
    }
...
var _default = exports["default"] = CrossBorderQuotesResponseQuote;