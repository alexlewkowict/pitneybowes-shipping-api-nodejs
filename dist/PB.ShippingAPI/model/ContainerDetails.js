...
var _CommodityInfo = _interopRequireDefault(require("./CommodityInfo"));
...
var ContainerDetails = /*#__PURE__*/function () {
   ...
   */
  return _createClass(ContainerDetails, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('commodityInfo')) {
          obj['commodityInfo'] = _ApiClient["default"].convertToType(data['commodityInfo'], [_CommodityInfo["default"]]);
        }
        if (data.hasOwnProperty('containerType')) {
          obj['containerType'] = _ApiClient["default"].convertToType(data['containerType'], 'String');
        }
        if (data.hasOwnProperty('packagingType')) {
          obj['packagingType'] = _ApiClient["default"].convertToType(data['packagingType'], 'String');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = ContainerDetails;