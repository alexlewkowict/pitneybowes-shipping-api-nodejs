...
var _ParcelProtectionQuoteRequestShipmentInfoShipperInfoAddress = _interopRequireDefault(require("./ParcelProtectionQuoteRequestShipmentInfoShipperInfoAddress"));
 ...
 * @version 1.0.0
 */
var ParcelProtectionQuoteRequestShipmentInfoShipperInfo = /*#__PURE__*/function () {
  /**
   ...
   */
  function ParcelProtectionQuoteRequestShipmentInfoShipperInfo(shipperID, address) {
    _classCallCheck(this, ParcelProtectionQuoteRequestShipmentInfoShipperInfo);
   ...
   */
  return _createClass(ParcelProtectionQuoteRequestShipmentInfoShipperInfo, null, [{
    key: "initialize",
    value: function initialize(obj, shipperID, address) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('address')) {
          obj['address'] = _ParcelProtectionQuoteRequestShipmentInfoShipperInfoAddress["default"].constructFromObject(data['address']);
        }
      }
      return obj;
    }
...
var _default = exports["default"] = ParcelProtectionQuoteRequestShipmentInfoShipperInfo;